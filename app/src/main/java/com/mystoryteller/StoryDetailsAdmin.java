...
public class StoryDetailsAdmin extends AppCompatActivity implements TextToSpeech.OnInitListener {
    private DatabaseHandler db;
    private Story story;
    private TextToSpeech tts;
    private Button btn_speak, btn_stop,btn_update;
    ImageView btn_back;
    TextView tv_title,tv_author,tv_content;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_story_details_admin);
        ...
        btn_update.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(StoryDetailsAdmin.this, Update.class);
